...
# podriamos hacer varios prompts para diferentes areas y despues hacer funciones para combinarlos y usarlos en el chain, por ejemplo prompts para marketing, egtc.