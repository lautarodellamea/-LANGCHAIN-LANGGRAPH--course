...
import os
from tkinter import Tk, filedialog # para la interfaz grafica
import openai # para la transcripcion de audio
...
def identify_topics(state: State) -> State:
    ...
    """
    # con pydantic podemos estructurar la respuesta del modelo, pero por simplicidad no lo haremos
