# Prompt principal para el sistema RAG: indica al LLM final la tarea que queremos realizar y con la  pregunta que realiza el usuario y el contexto que hemos recuperado de la base de datos vectorial y que hemos procesado con el LLM de consultas
# podriamos separar el system propmpt y human message prompt pero por simplicidad lo unimos en un solo prompt
...
# Prompt personalizado para el MultiQueryRetriever: este prompt se encarga de generar multiples versiones de la consulta del usuario para recuperar documentos relevantes desde una base de datos vectorial
