...
# CHROMDB_PATH = "C:\\Users\\santiago\\curso_langchain\\Tema \\chromadb"
CHROMDB_PATH = "C:\\LAUTARO\\LANGCHAIN\\curso_langchain\\tema_5\\08_memoria_vectorial_langgraph\\chromadb"
...
vectorstore = Chroma(
    collection_name="memoria_chat", # seria como un apartado (una base de datos en sql no una columna, no es un modelo relacional), que va a guardar la memoria de la conversacion
    embedding_function=OpenAIEmbeddings(model="text-embedding-3-large"),
    persist_directory=CHROMDB_PATH # si el directorio no existe, se crea automaticamente, y si existe, se usa el mismo no sobrescribe
)
...
# Funcion para iniciar la conversacion.
...
# Funcion para mostrar todas las memorias guardadas del usuario.
