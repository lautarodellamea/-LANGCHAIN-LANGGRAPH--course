# langchain recomienda crear agentes en produccion de esta forma con langraph
# Mismo setup que 01: credenciales, decode seguro, agente clásico
# este crea un borrador debajo de un email existente
...
# herramienta personalizada para obtener un email
...
# herramienta personalizada para buscar emails
...
# herramienta personalizada para crear un borrador de respuesta
@tool
