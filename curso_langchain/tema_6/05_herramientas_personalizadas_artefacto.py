...
# response_format="content_and_artifact" es para que devuelva el resultado de la herramienta y un artefacto
# el contenido es lo que va para el LLM y el artefacto es lo que va para el usuario
...
def herramienta_personalizada(query: str) -> Tuple[str, int]:
    ...
    return f"Respuesta a la consulta: {query}", 10 # ejemplo devolvemos respuesta a la consulta y el tiempo que tardo en ejecutarse
