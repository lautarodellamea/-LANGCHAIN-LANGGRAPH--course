...
@tool("Herramienta acceso base de datos usuarios", return_direct=True) # el return direct en true, en lugar de devolver el resultado de la herramienta al LLM, cuando el LLM invoque a esta herramienta, el resultado sera el resultado final de la ejecucion, no vuelve otra vez al LLM
